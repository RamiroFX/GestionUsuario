...
/**
 * <p>A table model similar to <code>DefaultTableModel</code> but 
 * based on <code>ArayList</code> instead of <code>Vector</code>.</p>
 * <p>This model haves the same methods of 
 * <code>DefaultTableModel</code> and adss an impplementation 
 * of <code>getColumnClass(int colNum)</code> method.</p>
 *  
...
public class ArrayListTableModel extends AbstractTableModel implements Serializable {
	...
	/**
	 * Constructs a default <code>ArrayListTableModel</code> which is a table of
	...
	public ArrayListTableModel() {
        ...
        public ArrayListTableModel(ResultSet results) throws SQLException {
	...
	/**
	 * Constructs an <code>ArrayListTableModel</code> with <code>rowCount</code>
   ...
   * @param columnNames       The names of the columns
	...
	/**
	 * Constructs an <code>ArrayListTableModel</code> and initializes the table
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
            if(dataArray==null){
                try {
		    results.absolute(rowIndex+1);                // Moverse a la fila indicada
		    Object o = results.getObject(columnIndex+1); // Se obtiene el valor de la columna indicada
		    if (o == null)
		    	return null;
		    else
	 ...
	 * @return the new <code>ArrayList</code> of <code>ArrayList</code>s; if
	 *         <code>anArray</code> is <code>null</code>, returns
	 *         <code>null</code>
	 */
	protected static ArrayList convertToArrayList(Object[][] anArray) {
		if (anArray == null) { return null; }
	 ...
	 * data will be added to model starting with the first element going to row 0,
	...
	/**
	 * Adds a column to the model. The new column will have the identifier
	 * <code>columnName</code>.<code>columnData</code> is the optional array
	 * of data for the column. If it is <code>null</code> the column is filled
	 * with <code>null</code> values. Otherwise, the new data will be added to
	 ...
	 * columns, new columns are added to the end of each row in the model. If the
	 * number of <code>newIdentifier</code> s is less than the current number of
	 * columns, all the extra columns at the end of a row are discarded.
	 * <p>
	 * 
	 ...
	 * 
	 * @param e
	 *          this <code>TableModelEvent</code> describes where the rows were
